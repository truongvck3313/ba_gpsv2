# import os
# try:
#     import decode, DrissionPage, mouse, retry
# except:
    # os.system("pip install cryptography==38.0.4")
    # os.system("pip install decode==1.0.0")
    # os.system("pip install decorator")
    # os.system("pip install DrissionPage")
    # os.system("pip install Faker==24.3.0")
    ...
    # os.system("pip install pyinstaller==6.5.0")
    # os.system("pip install pyinstaller-hooks-contrib==2024.3")
    ...
    #
    #
    # os.system("pip install altgraph")
    # os.system("pip install aspose-cells")
    # os.system("pip install astropy==5.2.2")
    # os.system("pip install asyncio")
    # os.system("pip install attrs")
    # os.system("pip install beautifulsoup4==4.12.3")
    # os.system("ip install Brotli")
    # os.system("pip install bs4")
    # os.system("pip install certifi")
    # os.system("pip install cffi")
    # os.system("pip install cftime")
    # os.system("pip install chardet")
    # os.system("pip install charset-normalizer")
    # os.system("pip install click")
    # os.system("pip install colorama")
    # os.system("pip install contourpy==1.1.0")
    # os.system("pip install cssselect")
    # os.system("pip install cssutils")
    # os.system("pip install currency-symbols")
    # os.system("pip install cycler")
    # os.system("pip install DataRecorder==3.4.12")
    # os.system("pip install dill")
    # os.system("pip install DownloadKit")
    # os.system("pip install et-xmlfile")
    # os.system("pip install exceptiongroup==1.2.0")
    # os.system("pip install filelock==3.13.3")
    # os.system("pip install fonttools==4.50.0")
    ...
    # os.system("pip install idna==3.6")
    # os.system("pip install importlib-metadata")
    # os.system("pip install importlib-resources==6.3.1")
    # os.system("pip install joblib==1.3.2")
    # os.system("pip install JPype1")
    # os.system("pip install kaitaistruct")
    # os.system("ppip install kiwisolver")
    # os.system("pip install lml")
    # os.system("pip install lxml==5.2.1")
    # os.system("pip install matplotlib==3.7.5")
    # os.system("pip install morecopy==0.3.0")
    ...
    # os.system("pip install plum-dispatch==1.7.4")
    # os.system("pip install psutil")
    # os.system("pip install py")
    # os.system("pip install pyasn1==0.5.1")
    # os.system("pip install pycparser==2.21")
    # os.system("pip install pydivert")
    # os.system("pip install pyerfa==2.0.0.3")
    # os.system("pip install pyexcel")
    # os.system("pip install pyexcel-cli")
    # os.system("pip install pyexcel-io")
    ...
    # os.system("pip install requests-file==2.0.0")
    # os.system("pip install scikit-learn==1.3.2")
    # os.system("pip install scipy==1.10.1")
    # os.system("pip install setuptools==69.2.0")
    # os.system("pip install six")
    # os.system("pip install wsproto")
    # os.system("pip install xarray==2022.12.0")
    # os.system("pip install xarray-dataclasses")
    # os.system("pip install XlsxWriter")
    # os.system("pip install xlwt")
    # os.system("pip install zipp==3.18.1")
...
class Test(unittest.TestCase):
    def test_run1(self):
        ...
        # caseid.caseid_giamsat115_1(self)
